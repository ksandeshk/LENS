# Obtain LENS and topk-div+LENS for random attack with different explanation methods.
...
lname = ["SG" , "IXG",  "LRP" , "DL",  "GS",  "IG"] # List of explanation methods 
attack_type = ["random"] # Attack types
...
for tt in train_type: # List of type of training the model
    for ll in lname: # List of explanation methods to obtain the LENS and Diversity values
        num_samples = 498 # assign number of samples 
